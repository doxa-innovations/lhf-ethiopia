...
export const dictionary = {
  en: {
    nav: {
      ...
      orgFullName: "Lutheran Heritage Foundation",
    },
    common: {
      readMore: "Read more",
      ...
      sectionLanguages: "Mother tongues",
    ...
    home: {
      ...
      languagesBody:
        "Ethiopia is home to 90+ languages. We add a new mother tongue whenever donors, translators, and a partner congregation come together.",
      ...
      bentoLine1: "One book.",
      bentoLine2: "One language.",
      bentoLine3: "One congregation.",
      bentoSolaLine1: "Sola",
      bentoSolaLine2: "Scriptura",
      bentoSeal: "The Lutheran Seal · Ethiopia",
      bentoBooksLabel: "Books",
      bentoHeartLangsLabel: "Mother tongues",
      bentoLangList: "Amharic · Afaan Oromoo · Tigrinya · …",
      impactChart1Title: "Books distributed per year",
      impactChart1Subtitle: "By mother tongue, 2020 → 2026",
      impactChart1Series: "Copies distributed",
      impactChart2Title: "Titles per language",
      impactChart2Subtitle: "The library today",
      impactChart2Series: "Titles",
    },
    about: {
      label: "About",
      title: "A Lutheran library, built one mother tongue at a time.",
      intro:
      ...
      statBooksLabel: "Books distributed in Ethiopia",
      statCongregationsLabel: "Congregations supplied",
      statProjectsLabel: "Active translation projects",
      statLangsLabel: "Mother tongues published in",
      statReviewersLabel: "Ethiopian reviewers trained",
    },
    publications: {
      label: "Publications",
      ...
      missingLanguageBody:
        "We open a new mother tongue whenever a congregation requests it and a sponsor steps forward. Tell us about your parish — and the language it prays in.",
      colTitle: "Title",
    ...
    donate: {
      ...
      amountLabel1: "1 catechism printed",
      amountLabel2: "Sunday-school pack of 5",
      amountLabel3: "Pastor's library starter set",
      amountLabel4: "Print run of 100 catechisms",
      allocPrinting: "Printing & paper",
      allocTranslation: "Translation review",
      allocDistribution: "Distribution & customs",
      allocOps: "Operations & admin",
      allocOfDollar: "of every dollar",
      allocCentsOfDollar: "¢ of every dollar",
    },
    contact: {
      label: "Contact",
  ...
  am: {
    ...
    common: {
      ...
      sectionPast: "ያለፉ",
      sectionImpact: "ተጽዕኖ",
      sectionLanguages: "የአፍ መፍቻ ቋንቋዎች",
    ...
    home: {
      ...
      languagesBody:
        "ኢትዮጵያ ከ90 በላይ ቋንቋዎች መኖሪያ ናት። ለጋሾች፣ ተርጓሚዎችና አጋር ጉባኤ በሚገናኙበት ጊዜ አዲስ የአፍ መፍቻ ቋንቋ እንጨምራለን።",
      ...
      bentoLine3: "አንድ ጉባኤ።",
      bentoSolaLine1: "ሶላ",
      bentoSolaLine2: "ስክሪፕቱራ",
      bentoSeal: "የሉተራን ማኅተም · ኢትዮጵያ",
      bentoBooksLabel: "መጻሕፍት",
      bentoHeartLangsLabel: "የአፍ መፍቻ ቋንቋዎች",
      bentoLangList: "አማርኛ · አፋን ኦሮሞ · ትግርኛ · …",
      impactChart1Title: "በዓመት የተሰራጩ መጻሕፍት",
      impactChart1Subtitle: "በልብ ቋንቋ፣ 2020 → 2026",
      impactChart1Series: "የተሰራጩ ቅጂዎች",
      impactChart2Title: "በቋንቋ ርዕሶች",
      impactChart2Subtitle: "ቤተ-መጻሕፍቱ ዛሬ",
      impactChart2Series: "ርዕሶች",
    },
    about: {
      label: "ስለ እኛ",
      title: "የሉተራን ቤተ-መጻሕፍት፣ በአንድ ጊዜ አንድ የአፍ መፍቻ ቋንቋ።",
      intro:
      ...
      visitLhf: "LHF ይጎብኙ",
      getInTouch: "ያግኙን",
      statBooksLabel: "በኢትዮጵያ የተሰራጩ መጻሕፍት",
      statCongregationsLabel: "የቀረቡ ጉባኤዎች",
      statProjectsLabel: "ንቁ የትርጉም ፕሮጀክቶች",
      statLangsLabel: "የታተሙባቸው የአፍ መፍቻ ቋንቋዎች",
      statReviewersLabel: "የሰለጠኑ ኢትዮጵያውያን ገምጋሚዎች",
    },
    publications: {
      label: "ህትመቶች",
      ...
      missingLanguageBody:
        "ጉባኤ በሚጠይቅበትና ስፖንሰር ሲነሳ አዲስ የአፍ መፍቻ ቋንቋ እንከፍታለን። ስለ ሰበካዎ — እና ስለሚጸልዩበት ቋንቋ ይንገሩን።",
      colTitle: "ርዕስ",
      colLanguage: "ቋንቋ",
      colAudience: "ተደራሽ",
      colStatus: "ሁኔታ",
      labelRegion: "ክልል",
      labelSpeakers: "ተናጋሪዎች",
      labelTitles: "ርዕሶች",
      pagesLabel: "ገጾች",
    },
    podcast: {
    ...
    events: {
      ...
      addToCalendar: "ወደ ቀን መቁጠሪያ አስቀምጥ",
      emailOffice: "ለቢሮው ኢሜል ይላኩ",
    },
    stories: {
      label: "ታሪኮች",
      title: "በራሳቸው ቃላት።",
    ...
    donate: {
      ...
      amountLabel1: "1 የታተመ ካቴኪዝም",
      amountLabel2: "የ5 ሰንበት-ትምህርት ጥቅል",
      amountLabel3: "የፓስተር ቤተ-መጻሕፍት ጀማሪ ጥቅል",
      amountLabel4: "የ100 ካቴኪዝም ህትመት",
      allocPrinting: "ህትመትና ወረቀት",
      allocTranslation: "የትርጉም ግምገማ",
      allocDistribution: "ሥርጭትና ጉምሩክ",
      allocOps: "ሥራዎችና አስተዳደር",
      allocOfDollar: "ከእያንዳንዱ ዶላር",
      allocCentsOfDollar: " ሳንቲም ከእያንዳንዱ ዶላር",
    },
    contact: {
      label: "አግኙን",
      title: "ስለ ጉባኤዎ ይንገሩን።",
  ...
  om: {
    ...
    common: {
      ...
      sectionImpact: "Bu'aa",
      sectionLanguages: "Afaanota haadhaa",
    ...
    home: {
      ...
      languagesBody:
        "Itoophiyaan mana afaanota 90+ ti. Yeroo arjoomtoonni, hiiktonni fi waldaa hirmaataan walitti dhufan afaan haadhaa haaraa dabalama.",
      ...
      bentoLine1: "Kitaaba tokko.",
      bentoLine2: "Afaan tokko.",
      bentoLine3: "Waldaa tokko.",
      bentoSolaLine1: "Sola",
      bentoSolaLine2: "Scriptura",
      bentoSeal: "Mallattoo Luuteraanaa · Itoophiyaa",
      bentoBooksLabel: "Kitaabota",
      bentoHeartLangsLabel: "Afaanota haadhaa",
      bentoLangList: "Amaariffa · Afaan Oromoo · Tigriiffa · …",
      impactChart1Title: "Kitaabota waggaatti raabsaman",
      impactChart1Subtitle: "Afaan haadhaatiin, 2020 → 2026",
      impactChart1Series: "Garagalcha raabsaman",
      impactChart2Title: "Matadureewwan afaaniin",
      impactChart2Subtitle: "Mana kitaabaa har'a",
      impactChart2Series: "Matadureewwan",
    },
    about: {
      label: "Waa'ee Keenya",
      title: "Mana kitaabaa Luuteraanaa, afaan haadhaa tokkoon tokkoon ijaarame.",
      intro:
      ...
      statBooksLabel: "Kitaabota Itoophiyaa keessatti raabsaman",
      statCongregationsLabel: "Waldaalee deeggaraman",
      statProjectsLabel: "Pirojektii hiikaa jiraa",
      statLangsLabel: "Afaanota haadhaa maxxansaman",
      statReviewersLabel: "Qorattoota Itoophiyaa leenjifaman",
    },
    publications: {
      label: "Maxxansa",
      ...
      missingLanguageBody:
        "Yeroo waldaan gaafatuu fi deeggaraan dhufu afaan haadhaa haaraa bannu. Waa'ee waldaa keetii fi afaan ittiin kadhatu nutti himi.",
      colTitle: "Mata duree",
      colLanguage: "Afaan",
      colAudience: "Hawaasa",
      colStatus: "Haala",
      labelRegion: "Naannoo",
      labelSpeakers: "Dubbattoota",
      labelTitles: "Matadureewwan",
      pagesLabel: "fuula",
    },
    podcast: {
    ...
    events: {
      ...
      addToCalendar: "Kaalandara irratti kuusi",
      emailOffice: "Waajjiraaf imeelii ergi",
    },
    stories: {
      label: "Seenaa",
    ...
    donate: {
      ...
      amountLabel1: "Catechism tokko maxxansa",
      amountLabel2: "Pakeejii mana barumsaa Sanbataa 5",
      amountLabel3: "Mana kitaabaa pastoraa jalqabaa",
      amountLabel4: "Maxxansa catechism 100",
      allocPrinting: "Maxxansa fi waraqaa",
      allocTranslation: "Qorannoo hiikaa",
      allocDistribution: "Raabsaa fi gumuruka",
      allocOps: "Hojii fi bulchiinsa",
      allocOfDollar: "doolaara hundaa keessaa",
      allocCentsOfDollar: " saantima doolaara hundaa keessaa",
    },
    contact: {
      label: "Nu Qunnamaa",
