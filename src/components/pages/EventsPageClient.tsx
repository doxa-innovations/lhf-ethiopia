          ...
          <div className="grid-2" style={{ gap: 36, alignItems: "center" }}>
            <Reveal>
              <span className="section-label">
                <EditableText
                  elementId="events.label"
                  defaultValue={t("events.label")}
                />
              </span>
              <h1 className="text-display">
                <EditableText
                  elementId="events.title"
                  defaultValue={t("events.title")}
                />
              </h1>
              <p className="text-body-lg" style={{ marginTop: 14, maxWidth: 520 }}>
                <EditableText
                  elementId="events.intro"
                  defaultValue={t("events.intro")}
                  multiline
                />
              </p>
              <div style={{ marginTop: 22, display: "flex", gap: 10, flexWrap: "wrap" }}>
                <Button href="/contact" variant="primary" size="md">
                  <EditableText
                    elementId="common.reserveSpot"
                    defaultValue={t("common.reserveSpot")}
                  />
                </Button>
                <Button href="/podcast" variant="secondary" size="md">
                  <EditableText
                    elementId="common.seePodcast"
                    defaultValue={t("common.seePodcast")}
                  />
                </Button>
              </div>
            </Reveal>
          ...
          <Reveal>
            <div style={{ marginBottom: 18 }}>
              ...
              <h2 className="text-h1">
                <EditableText
                  elementId="events.upcomingTitle"
                  defaultValue={t("events.upcomingTitle")}
                />
              </h2>
            </div>
          </Reveal>
            ...
            <Card>
              <CardBody>
                <div style={{ textAlign: "center", padding: "32px 16px", color: "rgb(var(--ink-faint))" }}>
                  ...
                  <div>
                    <EditableText
                      elementId="events.noUpcoming"
                      defaultValue={t("events.noUpcoming")}
                    />
                  </div>
                </div>
              </CardBody>
          ...
          <div className="container">
            <Reveal>
              <div style={{ marginBottom: 18 }}>
                <span className="section-label">
                  <EditableText
                    elementId="common.sectionPast"
                    defaultValue={t("common.sectionPast")}
                  />
                </span>
                <h2 className="text-h1">
                  <EditableText
                    elementId="events.pastTitle"
                    defaultValue={t("events.pastTitle")}
                  />
                </h2>
              </div>
            </Reveal>
        ...
        {isUpcoming ? (
          ...
          >
            ...
            >
              ...
              <EditableText
                elementId="events.addToCalendar"
                defaultValue={t("events.addToCalendar")}
              />
            </button>
            <a
              href={mailtoHref}
            ...
            >
              <Mail size={13} />{" "}
              <EditableText
                elementId="events.emailOffice"
                defaultValue={t("events.emailOffice")}
              />
            </a>
          </div>
        ) : null}
