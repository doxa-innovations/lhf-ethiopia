...
export default function PodcastPage() {
  const latest = [...PODCAST_EPISODES].sort((a, b) =>
    a.date < b.date ? 1 : -1,
  )[0];
      ...
      >
        ...
        <style>{`
          @media (max-width: 900px) {
            .podcast-hero-grid { grid-template-columns: 1fr !important; gap: 22px !important; }
          }
        `}</style>
      </section>
          ...
          <Reveal>
            ...
            >
              <div>
                ...
                <h2 className="text-h1">Browse the archive</h2>
              </div>
